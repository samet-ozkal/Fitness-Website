...
<head>
    ...
    <title>Ekipmansız Yağ Yakma</title>
    <style>
        body {
...
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises4 WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle4.php" enctype="multipart/form-data">
