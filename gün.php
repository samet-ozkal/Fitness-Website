...
<head>
    ...
    <title>Ekipmanlı Günlük Antrenman</title>
    <style>
        body {
...
<h1>Ekipmanlı Günlük Antrenman</h1>
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises7 WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle7.php" enctype="multipart/form-data">
