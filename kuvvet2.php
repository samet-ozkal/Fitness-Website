...
<head>
    ...
    <title>Ekipmansız Kuvvet Antrenmanı</title>
    <style>
        body {
...
<h1>Ekipmansız Kuvvet Antrenmanı</h1>
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises2 WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle2.php" enctype="multipart/form-data">
