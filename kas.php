...
<head>
    ...
    <title>Ekipmanlı Kas Kazanım Antrenmanı</title>
    <style>
        body {
...
<h1>Ekipmanlı Kas Kazanım Antrenmanı</h1>
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises5 WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle5.php" enctype="multipart/form-data">
