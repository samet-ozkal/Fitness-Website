...
<head>
    ...
    <title>Yağ Yakma Antrenmanı</title>
    <style>
        body {
...
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises3 WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle3.php" enctype="multipart/form-data">
