...
<head>
    ...
    <title>Ekipmansız Kas Kazanım Antrenmanı</title>
    <style>
        body {
...
<h1>Ekipmansız Kas Kazanım Antrenmanı</h1>
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises6 WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle6.php" enctype="multipart/form-data">
