...
<head>
    ...
    <title>Ekipmanlı Kuvvet Antrenmanı</title>
    <style>
        body {
...
<h1>Ekipmanlı Kuvvet Antrenmanı</h1>
<div class="exercise-container">
    ...
    foreach ($gunler as $gun) {
        $sql = "SELECT * FROM exercises WHERE day = '$gun'";
...
<div class="form-container">
    <h2>Egzersiz Ekle</h2>
    <form method="post" action="./egzersiz_ekle.php" enctype="multipart/form-data">
