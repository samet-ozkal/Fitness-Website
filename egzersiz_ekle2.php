...
$sql = "INSERT INTO exercises2 (day, exerciseName, imagePath, setCount) VALUES ('$day', '$exerciseName', '$target_file', '$setCount')";

if ($conn->query($sql) === TRUE) {
  echo "Egzersiz başarıyla eklendi";
  echo'<script>
  // Sayfanın yüklenmesinden 10 saniye sonra yönlendirme yap
  setTimeout(function() {
      window.location.href = "kuvvet2.php";
